...
class kinect_human_broadcaster():
    ...
    def __init__(self):
        ...
        self.joint_name_list = ["Neck", "Head", "ShoulderLeft", "ShoulderRight", "SpineShoulder", "HandRight"]
            ...
            if self.human_list != []:
                ...
                for j in range(0, len(self.human_list_sample)):
                    ...
                    for i in range(0, len(self.joint_list)):
                        ...
                        if self.joint_list[i].joint_id in self.joint_name_list[:5]:
                    ...
                    if "close" in self.distances:
                        ...
                        for i in range(0, len(self.joint_list)):
                            ...
                            if self.joint_list[i].joint_id == "HandRight":
                    ...
                    self.humans_pose_uni_to_sp.humans_zone_list.append(self.occupation_zone)
